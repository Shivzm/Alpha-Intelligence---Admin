  ...
  return (
    <div className="h-full w-full p-8 overflow-y-auto">
      <div className="flex items-center gap-4 mb-2">
        <i className="ri-dashboard-3-line text-4xl text-gray-400"></i>
        <h1 className="text-3xl font-semibold">Engine Performance</h1>
      </div>
      <p className="text-gray-500 text-sm mb-8">Live telemetry and resource utilization for the AI backend.</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        ...
        <div className="bg-[#0c0d12] border border-gray-800/80 rounded-xl p-6 relative overflow-hidden">
          ...
          <h3 className="text-gray-400 text-sm font-medium mb-1">Model Latency</h3>
          <div className="text-3xl font-bold text-white mb-2">124<span className="text-lg text-gray-500 font-normal">ms</span></div>
        ...
        <div className="bg-[#0c0d12] border border-gray-800/80 rounded-xl p-6 relative overflow-hidden">
          ...
          <h3 className="text-gray-400 text-sm font-medium mb-1">Intent Accuracy</h3>
          <div className="text-3xl font-bold text-white mb-2">98.4<span className="text-lg text-gray-500 font-normal">%</span></div>
          <div className="flex items-center gap-2 text-xs">
        ...
        <div className="bg-[#0c0d12] border border-gray-800/80 rounded-xl p-6 relative overflow-hidden">
          ...
          <h3 className="text-gray-400 text-sm font-medium mb-1">System Uptime</h3>
          <div className="text-3xl font-bold text-white mb-2">99.99<span className="text-lg text-gray-500 font-normal">%</span></div>
          <div className="flex items-center gap-2 text-xs">
      ...
      <div className="bg-[#0c0d12] border border-gray-800/80 rounded-xl p-8 mb-6">
        ...
        <div className="space-y-6">
          ...
          <div>
            <div className="flex justify-between text-sm mb-2">
              <span className="text-gray-400">CPU Usage (Cluster A)</span>
          ...
          <div>
            <div className="flex justify-between text-sm mb-2">
              <span className="text-gray-400">GPU VRAM (Model Inference)</span>
              <span className="text-white font-mono">89%</span>
            </div>
            <div className="w-full bg-gray-800/50 rounded-full h-2">
