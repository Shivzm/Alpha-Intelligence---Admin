...
export default function LoginPage() {
  return (
    <div className="h-screen w-full flex bg-[#111216] font-sans overflow-hidden p-4 md:p-6">
      
      {/* Left Column: Form Area */}
      {/* Removed items-center to prevent center-justification of the text block */}
      <div className="w-full md:w-1/2 h-full flex flex-col justify-center pl-8 md:pl-24 relative z-10">
        <div className="w-full max-w-[380px]">
          <h1 className="text-3xl text-white font-semibold tracking-wide mb-1">
            Alpha Intelligence
          </h1>
          <p className="text-[#8c8f9b] text-xl mb-10">
